...
export const onboardingSteps: OnboardingStep[] = [
  {
    ...
    description: "هسته پرداخت ایران کیش — یک کارت، همه پرداخت‌ها. هستو به شما کمک می‌کند تمام پرداخت‌های خود را یکجا مدیریت کنید.",
    icon: "👋",
    color: "#034ea2",
    highlights: ["کیف پول مرکزی یکپارچه", "مدیریت تمام کارت‌های بانکی", "پرداخت‌های هوشمند"],
  },
  {
    id: 2,
    title: "کیف پول مرکزی",
    description: "موجودی کیف پول مرکزی خود را در داشبورد ببینید. تمام پرداخت‌ها از این کیف پول انجام می‌شود و در صورت کمبود موجودی، به‌طور خودکار از بانک‌های متصل شارژ می‌شود.",
    icon: "💰",
    color: "#16a34a",
