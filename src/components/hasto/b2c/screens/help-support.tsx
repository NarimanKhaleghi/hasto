...
const faqs: FAQ[] = [
  {
    id: "faq-1",
    question: "کیف پول مرکزی چیست؟",
    answer: "کیف پول مرکزی یک حساب مرجع در بانک تجارت است که تمام پرداخت‌های شما از این حساب انجام می‌شود. در صورت کمبود موجودی، به‌طور خودکار از بانک‌های متصل شارژ می‌شود.",
    category: "حساب",
  },
  {
    id: "faq-2",
